    ...
    <div className="App">
      <main>
        <div className='intro'>
          ...
          <p className='info'>Our Artificial Intelligence powered tools use millions of project data
        ...
        <div className='grid'>
          {
            cards.map((card) => {
              ...
              return <Card title={title} content={content} classes={className} src={icon} />
            })
          }
        </div>
      </main>
